package com.cmota.playground.triathlon.androidApp.activities

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.fragment.app.Fragment
import com.cmota.playground.triathlon.androidApp.EXTRA_TAB_SELECTED
import com.cmota.playground.triathlon.androidApp.EXTRA_TAB_TITLE
import com.cmota.playground.triathlon.androidApp.R
import com.cmota.playground.triathlon.androidApp.databinding.ActivityMainBinding
import com.cmota.playground.triathlon.androidApp.fragments.ConferencesFragment
import com.cmota.playground.triathlon.androidApp.fragments.SettingsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedTabId = savedInstanceState?.getInt(EXTRA_TAB_SELECTED) ?: R.id.navigation_conferences
    ...
    private fun setup(): ArrayList<Fragment> {
        ...
        return arrayListOf(conferences, settings)
    }
